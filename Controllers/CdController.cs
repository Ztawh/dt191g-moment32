...
namespace dt191g_moment32.Controllers
{
    public class CdController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CdId,Title,Genre,Playtime,ArtistId")] Cd cd)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CdId,Title,Genre,Playtime,ArtistId")] Cd cd)
        {
            if (id != cd.CdId)
            {
                return NotFound();
